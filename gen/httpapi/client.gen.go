...
type ClientInterface interface {
	...
	// GetDeliveryUrlsWithBody request with any body
	GetDeliveryUrlsWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	GetDeliveryUrls(ctx context.Context, body GetDeliveryUrlsJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)
...
func (c *Client) GetDeliveryUrlsWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewGetDeliveryUrlsRequestWithBody(c.Server, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) GetDeliveryUrls(ctx context.Context, body GetDeliveryUrlsJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewGetDeliveryUrlsRequest(c.Server, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func NewConfirmUploadRequestWithBody(server string, contentType string, body io.Reader) (*http.Request, error) {
	...
	operationPath := fmt.Sprintf("/v1/images/confirm")
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
func NewCreatePresignRequestWithBody(server string, contentType string, body io.Reader) (*http.Request, error) {
	...
	operationPath := fmt.Sprintf("/v1/images/presign")
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
func NewPromoteImagesRequestWithBody(server string, contentType string, body io.Reader) (*http.Request, error) {
	...
	operationPath := fmt.Sprintf("/v1/images/promote")
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
// NewGetDeliveryUrlsRequest calls the generic GetDeliveryUrls builder with application/json body
func NewGetDeliveryUrlsRequest(server string, body GetDeliveryUrlsJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
	...
	bodyReader = bytes.NewReader(buf)
	return NewGetDeliveryUrlsRequestWithBody(server, "application/json", bodyReader)
}

// NewGetDeliveryUrlsRequestWithBody generates requests for GetDeliveryUrls with any type of body
func NewGetDeliveryUrlsRequestWithBody(server string, contentType string, body io.Reader) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/v1/images/urls")
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
func NewGetDeliveryUrlRequest(server string, id string, params *GetDeliveryUrlParams) (*http.Request, error) {
	...
	operationPath := fmt.Sprintf("/v1/images/%s/url", pathParam0)
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
func NewProcessImageRequestWithBody(server string, contentType string, body io.Reader) (*http.Request, error) {
	...
	operationPath := fmt.Sprintf("/v1/internal/images/process")
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
type ClientWithResponsesInterface interface {
	...
	// GetDeliveryUrlsWithBodyWithResponse request with any body
	GetDeliveryUrlsWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*GetDeliveryUrlsResponse, error)

	GetDeliveryUrlsWithResponse(ctx context.Context, body GetDeliveryUrlsJSONRequestBody, reqEditors ...RequestEditorFn) (*GetDeliveryUrlsResponse, error)
...
type GetDeliveryUrlsResponse struct {
	Body                      []byte
	HTTPResponse              *http.Response
	JSON200                   *BatchUrlResponse
	ApplicationproblemJSON400 *Problem
	ApplicationproblemJSON500 *Problem
}

// Status returns HTTPResponse.Status
func (r GetDeliveryUrlsResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r GetDeliveryUrlsResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
// GetDeliveryUrlsWithBodyWithResponse request with arbitrary body returning *GetDeliveryUrlsResponse
func (c *ClientWithResponses) GetDeliveryUrlsWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*GetDeliveryUrlsResponse, error) {
	rsp, err := c.GetDeliveryUrlsWithBody(ctx, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseGetDeliveryUrlsResponse(rsp)
}

func (c *ClientWithResponses) GetDeliveryUrlsWithResponse(ctx context.Context, body GetDeliveryUrlsJSONRequestBody, reqEditors ...RequestEditorFn) (*GetDeliveryUrlsResponse, error) {
	rsp, err := c.GetDeliveryUrls(ctx, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseGetDeliveryUrlsResponse(rsp)
...
// ParseGetDeliveryUrlsResponse parses an HTTP response from a GetDeliveryUrlsWithResponse call
func ParseGetDeliveryUrlsResponse(rsp *http.Response) (*GetDeliveryUrlsResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &GetDeliveryUrlsResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
