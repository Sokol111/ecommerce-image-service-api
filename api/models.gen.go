...
// Defines values for BatchUrlRequestFit.
const (
	BatchUrlRequestFitContain BatchUrlRequestFit = "contain"
	BatchUrlRequestFitCover   BatchUrlRequestFit = "cover"
	BatchUrlRequestFitFill    BatchUrlRequestFit = "fill"
	BatchUrlRequestFitInside  BatchUrlRequestFit = "inside"
	BatchUrlRequestFitOutside BatchUrlRequestFit = "outside"
)

// Defines values for BatchUrlRequestFormat.
const (
	BatchUrlRequestFormatAvif     BatchUrlRequestFormat = "avif"
	BatchUrlRequestFormatJpeg     BatchUrlRequestFormat = "jpeg"
	BatchUrlRequestFormatOriginal BatchUrlRequestFormat = "original"
	BatchUrlRequestFormatPng      BatchUrlRequestFormat = "png"
	BatchUrlRequestFormatWebp     BatchUrlRequestFormat = "webp"
)
...
const (
	Imageavif PresignRequestContentType = "image/avif"
...
const (
	GetDeliveryUrlParamsFitContain GetDeliveryUrlParamsFit = "contain"
	GetDeliveryUrlParamsFitCover   GetDeliveryUrlParamsFit = "cover"
	GetDeliveryUrlParamsFitFill    GetDeliveryUrlParamsFit = "fill"
	GetDeliveryUrlParamsFitInside  GetDeliveryUrlParamsFit = "inside"
	GetDeliveryUrlParamsFitOutside GetDeliveryUrlParamsFit = "outside"
)

// Defines values for GetDeliveryUrlParamsFormat.
const (
	GetDeliveryUrlParamsFormatAvif     GetDeliveryUrlParamsFormat = "avif"
	GetDeliveryUrlParamsFormatJpeg     GetDeliveryUrlParamsFormat = "jpeg"
	GetDeliveryUrlParamsFormatOriginal GetDeliveryUrlParamsFormat = "original"
	GetDeliveryUrlParamsFormatPng      GetDeliveryUrlParamsFormat = "png"
	GetDeliveryUrlParamsFormatWebp     GetDeliveryUrlParamsFormat = "webp"
)

// BatchUrlRequest defines model for BatchUrlRequest.
type BatchUrlRequest struct {
	Fit    *BatchUrlRequestFit    `json:"fit,omitempty"`
	Format *BatchUrlRequestFormat `json:"format,omitempty"`

	// H Height in pixels
	H *int `json:"h,omitempty"`

	// ImageIds List of image IDs to get URLs for (max 50)
...
// BatchUrlRequestFit defines model for BatchUrlRequest.Fit.
type BatchUrlRequestFit string

// BatchUrlRequestFormat defines model for BatchUrlRequest.Format.
type BatchUrlRequestFormat string

// BatchUrlResponse defines model for BatchUrlResponse.
type BatchUrlResponse struct {
	// NotFound Image IDs that were not found
...
type ConfirmRequest struct {
	...
	// UploadToken Signed JWT token from presign response
...
type PresignResponse struct {
	...
	// UploadToken Signed JWT token containing upload metadata (key, ownerType, ownerId, role, etc.)
	UploadToken string `json:"uploadToken"`
...
// GetDeliveryUrlsJSONRequestBody defines body for GetDeliveryUrls for application/json ContentType.
type GetDeliveryUrlsJSONRequestBody = BatchUrlRequest
