...
type ConfirmRequest struct {
	...
	Key       string              `json:"key"`
	Mime      *ConfirmRequestMime `json:"mime,omitempty"`
...
type PresignResponse struct {
	...
	// TempId Temporary ID for idempotency/confirm
...
type PromoteRequest struct {
	FromDraft string `json:"fromDraft"`
	...
	ToProduct string `json:"toProduct"`
}
...
// CreatePresignParams defines parameters for CreatePresign.
type CreatePresignParams struct {
	// IdempotencyKey Idempotency key for safe retries.
	IdempotencyKey *string `json:"Idempotency-Key,omitempty"`
}

// PromoteImagesParams defines parameters for PromoteImages.
type PromoteImagesParams struct {
	IdempotencyKey *string `json:"Idempotency-Key,omitempty"`
}
...
// S3WebhookJSONBody defines parameters for S3Webhook.
type S3WebhookJSONBody map[string]interface{}
...
// S3WebhookJSONRequestBody defines body for S3Webhook for application/json ContentType.
type S3WebhookJSONRequestBody S3WebhookJSONBody
