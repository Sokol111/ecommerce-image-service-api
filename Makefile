...
NPM_PACKAGE_NAME ?= @sokol111/ecommerce-image-service-api
PROJECT_NAME ?= ecommerce-image-service-api
AUTHOR ?= Sokol111
REPOSITORY_URL ?= https://github.com/Sokol111/ecommerce-image-service-api.git
